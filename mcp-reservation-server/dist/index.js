...
import { QueryReservationsArgs, QueryAllReservationsArgs, QueryByMobileArgs, QueryByNameArgs, UpdateReservationArgs, UpdateReservationTimeByMobileArgs, UpdateReservationTimeByNameArgs, DeleteReservationArgs, DeleteByMobileArgs, DeleteByNameArgs, getStatusText, } from './types.js';
// 服务器配置
    ...
    try {
        switch (name) {
            ...
            case 'get_available_meets': {
                ...
                meets.forEach((meet, index) => {
                    ...
                    if (meet.availableDays.length > 0) {
                        const firstFewDays = meet.availableDays.slice(0, 3).map((d) => d.day).join(', ');
            ...
            case 'get_available_time_slots': {
                ...
                const params = { meet_id: args.meet_id, day: args.day };
